            ...
            {processSteps.map((step, idx) => (
              ...
              >
                ...
                <div className="lg:col-span-4 border-b lg:border-b-0 lg:border-r border-gray-200 pb-6 lg:pb-0 lg:pr-8">
                  <span className="text-5xl font-black text-[#B22222] font-['Montserrat'] block">
                    {step.step}
                  </span>
                ...
                <div className="lg:col-span-8 space-y-4">
                  ...
                  <div className="bg-[#F8F9FA] p-5 rounded-2xl border border-gray-100">
                    <h4 className="font-bold text-xs text-[#000000] font-['Montserrat'] uppercase tracking-wider mb-3">
